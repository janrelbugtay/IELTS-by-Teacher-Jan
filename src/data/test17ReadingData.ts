  ...
  { 
    ...
    },
    {
        ...
        "questions": [
            {
                "id": 20,
                "text": "The creation of some new technologies did not change viewers' attitudes towards documentaries as quickly as is sometimes proposed."
            },
            {
                "id": 21,
                "text": "One set of beliefs and techniques helped to make documentary films academically respectable."
            },
            {
                "id": 22,
                "text": "The action of putting material on film essentially changes the nature of the original material."
            },
            {
                "id": 23,
                "text": "Documentary filmmakers have an obligation to include their own opinions about and analysis of the real events that they show in their films."
            }
        ]
    },
    {
        ...
        "questions": [
            {
                "id": 24,
                "text": "Hamburg Short Film Festival lives up to its name by accepting films no more than..."
            },
            {
                "id": 25,
                "text": "The Short and Sweet Film Festival is especially good for documentary makers who are..."
            },
            {
                "id": 26,
                "text": "Atlanta Shortsfest accepts numerous forms of documentaries including..."
            }
        ]
    }
] 
