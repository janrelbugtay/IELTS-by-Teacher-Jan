    ...
    questionBlocks: [
      {
        ...
        text: "The Tasmanian tiger, also called thylacine, resembles the look of a dog and has {14} on its fur coat. Many fossils have been found, showing that thylacines had existed as early as {15} years ago. They lived throughout {16} before disappearing from the mainland. And soon after the {17} settled the size of the thylacine population in Tasmania shrunk at a higher speed.",
        type: "summary-input",
        questions: [
...
export const test16Answers: Record<number, string> = {
  "1": "v",
  "2": "i",
  "3": "vi",
  "4": "x",
...
export const test16Explanations: Record<number, any> = {
  "1": {
    "passageId": 1,
    "highlights": [
  ...
  "14": {
    "passageId": 2,
    "highlights": [
      "It had 12 distinct stripes on its back..."
    ],
  ...
  "17": {
    "passageId": 2,
    "highlights": [
      "...declining in Tasmania at the time of European settlement 200 years ago, but the decline was certainly accelerated by the new arrivals."
    ],
  ...
  "18": {
    "passageId": 2,
    "highlights": [
      "I was besieged by television crews, including four to five from Japan, and others from the United Kingdom, Germany..."
    ],
  ...
  "19": {
    "passageId": 2,
    "highlights": [
      "Mooney has seen it all – the mistakes, the hoaxes, the illusions..."
    ],
  ...
  "20": {
    "passageId": 2,
    "highlights": [
      "...despite scientific thinking that 500 animals are required to sustain a population, the Florida panther is down to a dozen..."
    ],
  ...
  "23": {
    "passageId": 2,
    "highlights": [
      "It is a blind optimism... If something crosses the road, it's not a case of 'I wonder what that was?' Rather, it is a case of 'that's a thylacine!'"
    ],
  ...
  "24": {
    "passageId": 2,
    "highlights": [
      "Government and private search parties combed the region..."
    ],
  ...
  "25": {
    "passageId": 2,
    "highlights": [
      "...was thought to have died out along with the dinosaurs... until a specimen was dragged to the surface..."
    ],
  ...
  "26": {
    "passageId": 2,
    "highlights": [
      "Mooney treats all reports on face value. 'I never try to embarrass people or make fools of them.'"
    ],
  ...
  "27": {
    "passageId": 3,
    "highlights": [
      "He predicts that by the middle of the next century, only about 600 will be left."
    ],
  ...
  "28": {
    "passageId": 3,
    "highlights": [
      "In Australia, however, thanks to the efforts of Nick Evans and his colleagues, the record is much better."
    ],
  ...
  "29": {
    "passageId": 3,
    "highlights": [
      "But technology is not enough. You still need the linguist to do the analysis."
    ],
  ...
  "31": {
    "passageId": 3,
    "highlights": [
      "It requires a linguist to spend years in the field... And you need the money to support them."
    ],
  ...
  "32": {
    "passageId": 3,
    "highlights": [
      "To a theoretical linguist [like Chomsky], the death of a language is not necessarily a catastrophe. It is merely the loss of one more superficial variation."
    ],
  ...
  "33": {
    "passageId": 3,
    "highlights": [
      "The answer is analogous to the reason why we should care about the loss of the ozone layer... It is about diversity."
    ],
  ...
  "34": {
    "passageId": 3,
    "highlights": [
      "...complex systems of kinship terms that encode the social structure... If the language is replaced by a creole... this social knowledge is lost."
    ],
  ...
  "35": {
    "passageId": 3,
    "highlights": [
      "In South America and West Africa, where the rate of language loss is just as high as in Australia..."
    ],
  ...
  "36": {
    "passageId": 3,
    "highlights": [
      "...complained that linguistics is the only discipline that is presiding over the disappearance of its own subject matter."
    ],
