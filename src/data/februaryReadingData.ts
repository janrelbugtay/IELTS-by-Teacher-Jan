export const febPassages = [
    ...
    questionBlocks: [
      {
        ...
        questions: [
          { id: 1, text: "The TF NextStage stores planned to sell products to make life easier for older people." },
          { id: 2, text: "TF’s market research indicated that people liked the products." },
          { id: 3, text: "It cost more than expected to remodel the TF stores." },
          { id: 4, text: "The TF NextStage coffee shops sold their own brand of food and drink." },
          { id: 5, text: "TF NextStage customers liked the atmosphere in the new stores." }
        ]
      },
      {
        ...
        type: "input",
        questions: [
          { id: 6, text: "Donna Sturgess - Problems with customer research: TF team limited their research to attitudes that occur at a ... level in customers' minds" },
          { id: 7, text: "How my company dealt with a similar problem (Product: Alli). Use: help people achieve ..." },
          { id: 8, text: "Marketing aim: help customers see the product in a positive way by giving the product a ... that seems helpful and supportive" },
          { id: 9, text: "giving the product a reusable ..." },
          { id: 10, text: "Market research: does not need to be complex; good information can come from interviews or studying the ... of consumers in the home" },
          { id: 11, text: "Alex Lee - How my company dealt with a similar problem: we organized ... to find out what images customers associate with our products" },
          { id: 12, text: "Market research: can be basic, e.g. by doing ..." },
          { id: 13, text: "company executives should follow their ..." }
        ]
      }
    ]
  },
  {
    ...
    subtitle: "The return of monkey life",
    content: [
    ...
    questionBlocks: [
      {
        ...
        type: "input",
        questions: [
          { id: 14, text: "a reason why newer forests provide howlers with better feeding opportunities than older forests" },
          { id: 15, text: "a reference to a change in farmers’ attitudes towards wildlife" },
          { id: 16, text: "a description of the means by which howlers select the best available diet for themselves" },
          { id: 17, text: "figures relating to the reduction of natural wildlife habitat over a period of time" }
        ]
      },
      {
        ...
        type: "input",
        questions: [
          { id: 18, text: "Why do howlers have an advantage over other Central American monkeys? Howler monkeys have a more rapid rate of ... than either capuchin of spider monkeys." },
          { id: 19, text: "Unlike the other local monkey species, howlers can survive without eating ..., and so can live inside a relatively small habitat area." },
          { id: 20, text: "Their diet is more flexible, and they are able to tolerate leaves with high levels of ..." },
          { id: 21, text: "Howlers can also survive periods of ... better than the other monkey species can." }
        ]
      },
      {
        title: "Questions 22-26",
        instruction: "Look at the following features and match each feature with the correct location (A, B or C).\nA - Hacienda La Pacifica\nB - Santa Rosa National Park\nC - Cholula Cacao Farm",
        type: "choice",
        options: ["A", "B", "C"],
        questions: [
          { id: 22, text: "It has seen the return of native tree species." },
          { id: 23, text: "It supports only one species of native monkey." },
          { id: 24, text: "Its monkey population helps the agriculture of the area." },
          { id: 25, text: "It is home to populations of all three local monkey species." },
          { id: 26, text: "Its landscape was altered by the construction of a transport link." }
        ]
      }
    ]
  },
  {
    ...
    subtitle: "The value of research into mite harvestmen",
    content: [
    ...
    questionBlocks: [
      {
        ...
        questions: [
          {
            id: 27,
            text: "Why is it difficult to find mite harvestmen?",
            options: [
          ...
          {
            id: 28,
            text: "Why are mile harvestmen of interest to Dr Giribet and his colleagues?",
            options: [
          ...
          {
            id: 29,
            text: "What factor contributed to Wegener's idea that present-day continents used to form a single landmass?",
            options: [
          ...
          {
            id: 30,
            text: "What point is made by the reference to armadillos?",
            options: [
          ...
          {
            id: 31,
            text: "Which of the following is stated in the fifth paragraph?",
            options: [
          ...
          {
            id: 32,
            text: "Why is evidence from cockroaches of limited value?",
            options: [
      ...
      },
      {
        ...
        questions: [
          { id: 33, text: "The colonization of Hawaii by geese provides evidence of continental drift" },
          { id: 34, text: "The reason why mite harvestmen don’t exist on Hawaii can be explained" },
          { id: 35, text: "The DNA of certain species has evolved more quickly than that of others" },
          { id: 36, text: "Dr Boyer’s theory concerning the origins of Florida is widely accepted" }
        ]
      },
      {
        ...
        options: ["A branches", "B fossils", "C drift", "D DNA", "E evolution", "F Pangea", "G dispersal", "H ancestors", "I continents"],
        text: "The age and evolution of mite harvestmen\nSome of the first creatures to live on land were the {37} of mite harvestmen. Boyer, Giribet and others study differences in the {38} of these insects, and trace the development of a number of {39} of the species.\n\nTheir evolution appears to reflect changes in the location of {40}. For example, the same type of mite harvestman is found in places that are now far apart but used to form Gondwana, part of a huge landmass."
      }
    ]
  }
];

export const febAnswers = {
  1: "FALSE", 2: "TRUE", 3: "NOT GIVEN", 4: "NOT GIVEN", 5: "FALSE",
  6: "SURFACE", 7: "WEIGHT LOSS", 8: "NAME", 9: "CONTAINER", 10: "BEHAVIOR",
  11: "FOCUS GROUPS", 12: "SURVEYS", 13: "INSTINCTS",
  14: "C", 15: "G", 16: "E", 17: "B", 
  18: "REPRODUCTION", 19: "FRUIT", 20: "TOXIN", 21: "DROUGHT",
  22: "B", 23: "A", 24: "C", 25: "B", 26: "A",
  27: "C", 28: "D", 29: "B", 30: "A", 31: "D", 32: "A",
  33: "NO", 34: "YES", 35: "NOT GIVEN", 36: "NOT GIVEN",
  37: "H", 38: "D", 39: "A", 40: "I"
};

export const febExplanations = {
  1: { passageId: 1, highlights: ["When Tibal Fisher... decided to change the company's image, he did so by redesigning its stores... to appeal to a younger demographic"], explanation: "The passage indicates TF NextStage was redesigned to appeal to a younger demographic, contradicting the statement that it was for older people.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  2: { passageId: 1, highlights: ["Initial market research was highly positive... customers gave the new products high ratings"], explanation: "The text confirms that market research was positive and customers gave high ratings.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  3: { passageId: 1, highlights: [], explanation: "The passage does not provide information about the expected versus actual cost of remodeling the stores.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  4: { passageId: 1, highlights: [], explanation: "The passage mentions coffee shops but does not specify if they sold their own brand of food and drink.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  5: { passageId: 1, highlights: ["In practice, however, sales actually fell... Customers complained that the new stores felt cold and unwelcoming"], explanation: "Customers complained about the atmosphere feeling cold, which contradicts the statement that they liked it.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  6: { passageId: 1, highlights: ["Tibal and his executives looked only at surface attitudes."], explanation: "The passage mentions that the executives only looked at 'surface attitudes' which were a small part of the total response.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  7: { passageId: 1, highlights: ["A great example is Alli (pronounced ‘ally’), a drug to aid weight loss."], explanation: "The drug Alli is explicitly described as a drug used to aid 'weight loss'.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  8: { passageId: 1, highlights: ["First we came up with a name that sounds like a helpful partner."], explanation: "They gave the product a 'name' that sounded like a helpful partner.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  9: { passageId: 1, highlights: ["make the container both beautiful and functional - something that didn’t just hold pills but could later be used to store diet guides"], explanation: "The strategy included making a reusable 'container' that could store guides and recipes later.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  10: { passageId: 1, highlights: ["ethnographical observation that involves going into people's houses to examine their behavior"], explanation: "Good information can come from going into houses and studying consumer 'behavior'.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  11: { passageId: 1, highlights: ["We conducted what are known as focus groups, where participants were asked to look at photos"], explanation: "Alex Lee states they organized 'focus groups' to understand the associations customers had with their products.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  12: { passageId: 1, highlights: ["we have conducted simple surveys in the lobby of our building"], explanation: "Market research can be basic, such as doing 'surveys' in the lobby.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  13: { passageId: 1, highlights: ["Sometimes the most important signals come from an executive's own instincts."], explanation: "The passage states that the most important signals can sometimes come from an executive's own 'instincts'.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  
  14: { passageId: 2, highlights: ["In younger forests, trees put most of their limited energy into growing wood, leaves, and fruit, so they produce much lower levels of toxin than do well-established, old-growth trees."], explanation: "Paragraph C explains that younger (newer) forests produce lower levels of toxins, making them better for feeding.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  15: { passageId: 2, highlights: ["He hopes that farmers will begin to see the advantages of associating with wild monkeys", "‘We’re moving away from that vision and beginning to consider ways in which commercial activities may become a tool for the conservation"], explanation: "Paragraph G references a shift in moving away from viewing conservation as a conflict with farming, indicating a change in attitude.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  16: { passageId: 2, highlights: ["Howlers are very adaptable feeders, and only need a comparatively small home range", "leaves howlers eat hold plenty of water, so the monkeys can survive away from open streams and water holes"], explanation: "Paragraph E describes how howlers are adaptable feeders and survive based on the specific traits of their diet.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  17: { passageId: 2, highlights: ["In the 18th century, tropical dry forests once covered most of Central America, but by the 1980s less than two percent remained undisturbed, and less than one percent was protected."], explanation: "Paragraph B provides figures (percentages and centuries) relating to the reduction of natural habitats.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  18: { passageId: 2, highlights: ["Howler reproduction is faster than that of other native monkey species."], explanation: "The passage states that their rate of 'reproduction' is faster than other native monkey species.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  19: { passageId: 2, highlights: ["They eat fruit when it is available but, unlike capuchin and spider monkeys, do not depend on large areas of fruiting trees."], explanation: "Unlike other monkeys, howlers do not depend on 'fruit' and can survive without large areas of fruiting trees.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  20: { passageId: 2, highlights: ["they produce much lower levels of toxin than do well-established, old-growth trees.", "increase their ability to neutralize the poisonous substances"], explanation: "They are adaptable to eating leaves loaded with 'toxin' (or toxins) by neutralizing poisonous substances.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  21: { passageId: 2, highlights: ["This ability gives them a real advantage over capuchin and spider monkeys, which have suffered during the long, ongoing drought in the area."], explanation: "Howlers have an advantage over other monkeys during ongoing periods of 'drought'.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  22: { passageId: 2, highlights: ["species of Indigenous trees which had been absent for decades began to invade the abandoned pastures."], explanation: "In Santa Rosa National Park (B), indigenous tree species returned to abandoned pastures.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  23: { passageId: 2, highlights: ["Other native primates- white-faced capuchin monkeys and spider monkeys were once common in this area, too, but vanished"], explanation: "At Hacienda La Pacifica (A), other monkey species vanished, leaving only howler monkeys.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  24: { passageId: 2, highlights: ["Estrada believes the monkeys bring underappreciated benefits to such plantations, dispersing the seeds of fruits such as fig and other shade trees, and fertilizing the soil."], explanation: "At Cholula Cacao Farm (C), the monkeys disperse seeds and fertilize soil, helping agriculture.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  25: { passageId: 2, highlights: ["Capuchins were the first to begin using the reborn forests, followed by howlers. Eventually, even spider monkeys, fruit-eaters that need large areas of continuous forest, returned."], explanation: "At Santa Rosa National Park (B), all three local monkey species eventually returned.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  26: { passageId: 2, highlights: ["vanished after the Pan-American Highway was built nearby in the 1950s"], explanation: "At Hacienda La Pacifica (A), the landscape was altered by the construction of a transport link (Pan-American Highway).", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  27: { passageId: 3, highlights: ["The animals respond by turning motionless, making them impossible for even a trained eye to pick out. 'They look like grains of dirt.'"], explanation: "They are hard to find because they turn motionless and look like dirt, making them hard to distinguish from their surroundings.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  28: { passageId: 3, highlights: ["they carry a record of hundreds of millions of years of geological history, chronicling the journeys that continents have made around the Earth."], explanation: "They provide evidence for geological history and continental drift (a field of study other than just insect biology).", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  29: { passageId: 3, highlights: ["fossils of similar animals and plants could be found on either side of the Atlantic. The ocean was too big for the species to have traveled across it on their own."], explanation: "Wegener noticed similar fossils across the Atlantic and realized the distance across the ocean was too far for species to travel, leading to his theory.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  30: { passageId: 3, highlights: ["ancestors evolved when the continents were joined. When South America and North America connected a few million years ago, armadillos spread north, too."], explanation: "Armadillos show how regions separated but also became connected again, allowing animals to spread.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  31: { passageId: 3, highlights: ["Having colonized Hawaii, it branched off from that species, losing its ability to fly."], explanation: "The fifth paragraph explicitly states that the goose evolved into a flightless bird after arriving and colonizing Hawaii.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  32: { passageId: 3, highlights: ["It is difficult to say much about where cockroaches evolved, for example, because they can move quickly from continent to continent."], explanation: "Cockroaches move too quickly between continents, meaning they spread too fast to provide accurate historical biogeographical data.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  33: { passageId: 3, highlights: ["must also recognize cases where species have spread for other reasons, such as by crossing great stretches of water. The island of Hawaii, for example, was home to a giant flightless goose"], explanation: "Geese spread to Hawaii by crossing water, which is an exception to continental drift, not evidence for it.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  34: { passageId: 3, highlights: ["Harvestmen are not found on young islands like Hawaii, as these types of islands emerged long after the break-up of Pangea."], explanation: "The passage explains they aren't on Hawaii because the island emerged long after Pangea broke up and harvestmen can't disperse well over water.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  35: { passageId: 3, highlights: ["By calculating how quickly the DNA mutated, the scientists could estimate when lineages branched off."], explanation: "The passage mentions scientists calculate how quickly DNA mutated, but does not state whether some species' DNA evolved faster than others.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  36: { passageId: 3, highlights: ["Dr Boyer then began investigating the geological history of Florida and found recent research to explain the mystery."], explanation: "While Dr. Boyer found recent research to explain Florida's origin, the text never says if this theory is 'widely accepted'.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  37: { passageId: 3, highlights: ["Their ancestors were among the first land animals"], explanation: "The ancestors (H) of mite harvestmen were among the first land animals.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  38: { passageId: 3, highlights: ["gathered thousands of mite harvestmen... from which they extracted DNA. Variations in the genes helped the scientists build an evolutionary tree."], explanation: "They study differences and variations in the DNA (D) of these insects.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  39: { passageId: 3, highlights: ["scientists could estimate when lineages branched off."], explanation: "They trace the development and the branches (A) where lineages split.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  40: { passageId: 3, highlights: ["They then compared the harvestmen's evolution to the movements of the continents."], explanation: "The evolution patterns perfectly reflect changes in the locations and movements of the continents (I).", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." }
};
