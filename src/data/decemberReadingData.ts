    ...
    questionBlocks: [
      {
        ...
        endQuestion: 7,
        questions: [
          { id: 1, text: "Water hyacinth was introduced as a decorative plant in east Africa." },
          { id: 2, text: "Fishermen took some water hyacinth plants to Lake Victoria." },
          { id: 3, text: "It is now difficult to force boats through the thick water hyacinth on Lake Victoria." },
          { id: 4, text: "Chemicals produced by the water hyacinth plants are affecting the numbers of fish in Lake Victoria." },
          { id: 5, text: "Cooking with charcoal has been proved to be even worse for people's health than cooking with wood." },
          { id: 6, text: "People found it impossible to remove much water hyacinth from Lake Victoria." },
          { id: 7, text: "Scientists started investigating the possibility of using water hyacinth to generate biogas in the last century." }
        ]
      },
      {
        type: "input",
        ...
        endQuestion: 10,
        questions: [
          { id: 8, text: "First, place water hyacinth together with some _______ into a digester" },
          { id: 9, text: "Leave the mixture until the _______ is completed" },
          { id: 10, text: "Capture the gas emitted by the digester and use _______ to transport it to individual homes\n\nThen use the gas for cooking as well as making water fit for human consumption" }
        ]
      },
      {
        type: "input",
        ...
        endQuestion: 13,
        questions: [
          { id: 11, text: "Benefits for the women in the village of cooking with biogas:\n• no need for them to spend so much _______ collecting fuel" },
          { id: 12, text: "• they can focus on different tasks that bring in _______" },
          { id: 13, text: "• they are less likely to experience certain diseases connected to burning wood\n\nDrawbacks of changing to biogas:\n• the _______ of the digesters is beyond the reach of most villages" }
        ]
      }
    ]
  },
...
export const decemberAnswers: Record<string, string> = {
  "1": "TRUE",
  "2": "FALSE",
  "3": "TRUE",
  "4": "NOT GIVEN",
...
Synonym example: difficult to force boats through = struggle to navigate`
  ...
  "4": {
    passageId: 1,
    highlights: ["blocking fishing routes and providing a new habitat for disease-carrying mosquitoes"],
  ...
  "5": {
    passageId: 1,
    highlights: ["About three out of four families in Kenya depend on wood or charcoal to cook their daily meals"],
...
Synonym example: perform better = fewer fail (contradicts)`
  ...
  "21": {
    passageId: 2,
    highlights: ["low educational achievement can lead to many of these students dropping out of school – a problem disproportionately affecting female students."],
...
Synonym example: is correct = contrary to (contradicts)`
  ...
  "34": {
    passageId: 3,
    highlights: ["He likened the world to a leather ball stitched together from twelve pieces, with the differing colours of the leather representing the different climates and zones of the earth."],
  ...
  "35": {
    passageId: 3,
    highlights: ["it was another 400 years before the first recorded globe was made by Crates of Mallus."],
