...
Link : So yeah, even when the problems are the same, the legal solutions don't always match.`
  ...
  'fallback': {
    ...
    part3: [
      { id: 'p3_1', topic: 'Reading', text: 'How have reading habits changed since the internet became popular?' },
      { id: 'p3_2', topic: 'Reading', text: 'Do you think printed books will eventually disappear?' }
    ]
  }
};
