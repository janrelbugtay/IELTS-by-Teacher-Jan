export const mayPassages = [
  {
    id: 1,
    title: "READING PASSAGE 1",
    subtitle: "A Wonder Plant-Bamboo",
    content: [
      ...
      "A. Every year, during the rainy season, the mountain gorillas of Central Africa migrate to the foothills and lower slopes of the Virunga Mountains to graze on bamboo. For the 650 or so that remain in the wild, it’s a vital food source. Although there are almost 150 types of plant, as well as various insects and other invertebrates, bamboo accounts for up to 90 percent of their diet at this time of year. Without it, says Ian Redmond, chairman of the Ape Alliance, their chances of survival would be reduced significantly. Gorillas aren’t the only locals keen on bamboo. For the people who live close to the Virungas, it’s a valuable and versatile raw material used for building houses and making household items such as mats and baskets. But in the past 100 years or so, resources have come under increasing pressure as populations have exploded and large areas of bamboo forest have been cleared to make way for farms and commercial plantations.",
    ...
    questionBlocks: [
      {
        title: "Questions 1-7",
        instruction: "Reading Passage 1 has six sections A-F. Which section contains the following information? Write the correct letter A-F.",
        type: "input",
        questions: [
          { id: 1, text: "Limited extent of existing research" },
          { id: 2, text: "Comparison of bamboo with other plant species" },
          { id: 3, text: "Commercial application of bamboo" },
          { id: 4, text: "Bamboo's application in a variety of uses" },
          { id: 5, text: "Human activity that damaged large areas of bamboo" },
          { id: 6, text: "The approaches used to study bamboo" },
          { id: 7, text: "Bamboo helps the survival of a range of plants" }
        ]
      },
      {
        title: "Questions 8-11",
        instruction: "Match the people with their opinions or deeds. Choose A, B, C or D.\nA. Ian Redmond\nB. Valerie Kapos\nC. Ray Townsend\nD. Chris Stapleton",
        type: "choice",
        options: ["A", "B", "C", "D"],
        questions: [
          { id: 8, text: "Destroying bamboo jeopardizes to wildlife." },
          { id: 9, text: "People have very confined knowledge of bamboo." },
          { id: 10, text: "Some people do not think that bamboo is endangered." },
          { id: 11, text: "Bamboo has loads of commercial potentials." }
        ]
      },
      {
        ...
        type: "input",
        questions: [
          { id: 12, text: "What problem does the bamboo's root system prevent?" },
          { id: 13, text: "Which bamboo product is experiencing market expansion?" }
        ]
      }
    ]
  },
    ...
    questionBlocks: [
      {
        ...
        instruction: "Match the category of navigation method (A-C) with the correct statement.\nA. Guidance\nB. Path integration\nC. Route following",
        type: "choice",
        options: ["A", "B", "C"],
        questions: [
          { id: 14, text: "Using basic direction from starting point and light intensity to move on." },
          { id: 15, text: "Using combination of place and direction heading for destination." },
          { id: 16, text: "Using an iconic building near your destination as orientation." },
          { id: 17, text: "Using a retrace method from a known place if a mistake happens." },
          { id: 18, text: "Using a passed spot as reference for a new integration." }
        ]
      },
      {
        ...
        questions: [
          { 
            id: 19, 
            text: "What does the ant of Cataglyphis respond if it has been taken to another location according to the passage?",
            options: [
          ...
          { 
            id: 20, 
            text: "Which of the followings is true about “cognitive map” in this passage?",
            options: [
          ...
          { 
            id: 21, 
            text: "Which of following description of way findings correctly reflects the function of cognitive map?",
            options: [
      ...
      },
      {
        ...
        questions: [
          { id: 22, text: "Biological navigation has a state of flexibility." },
          { id: 23, text: "You will always receive good reaction when you ask direction." },
          { id: 24, text: "When someone follows a route, he or she collects comprehensive perceptional information in mind on the way." },
          { id: 25, text: "Path integration requires more thought from brain compared with route-following." },
          { id: 26, text: "In a familiar surrounding, an exact map of where you are will automatically emerge in your head." },
          { id: 27, text: "A literal map in our heads can be accurate." }
        ]
      }
    ]
  },
  {
    ...
    content: [
      "Could better design cure our throw away culture?",
    ...
    questionBlocks: [
      {
        ...
        questions: [
          { 
            id: 28, 
            text: "What does ‘conscience time’ imply in paragraph 2?",
            options: [
          ...
          { 
            id: 29, 
            text: "Prior to the mass production, people own things to show",
            options: [
              "A their quality",
              "B their status",
              "C their character",
          ...
          { 
            id: 30, 
            text: "The word ‘narrative’ in paragraph 3 refers to",
            options: [
          ...
          { 
            id: 31, 
            text: "Without personal connection, people buy new stuff for",
            options: [
              "A sharing",
              "B freshness",
              "C collection",
          ...
          { 
            id: 32, 
            text: "The writer quotes the old jeans and teddy bear to illustrate that",
            options: [
      ...
      },
      {
        ...
        instruction: "Complete the summary using the list of words (A-H). Write the correct letter.\nA. properly\nB. energy\nC. locally\nD. economy\nE. slowly\nF. speed\nG. quickly\nH. metabolism",
        type: "input",
        questions: [
          { id: 33, text: "Tim Cooper claims that although sustainable design proceeds ..." },
          { id: 34, text: "In accordance with Tim Cooper, Thackara believes that the origins of the looming environmental crises are weight and ..." },
          { id: 35, text: "The technology which was assumed to have a positive effect on our society actually accelerates the world’s ..." },
          { id: 36, text: "To cure this, Manzini proposes a ‘multi-local society’ which means every resource should be located and redeployed ..." }
        ]
      },
      {
        ...
        options: ["TRUE", "FALSE", "NOT GIVEN"],
        questions: [
          { id: 37, text: "People often buy things that are seldom used and throw them away." },
          { id: 38, text: "In a post-throwaway society, we will pay extra money after disposing the electronic goods." },
          { id: 39, text: "Some businesses have jumped on the sustainability bandwagon." },
          { id: 40, text: "Company will spend less on repairing in the future." }
        ]
      }
    ]
  }
...
export const mayAnswers = {
  1: "B", 2: "F", 3: "D", 4: "D", 5: "A", 6: "B", 7: "C",
  8: "A", 9: "B", 10: "B", 11: "D",
  12: "SOIL EROSION", 13: "PAPER",
  14: "B", 15: "C", 16: "A", 17: "C", 18: "B",
  19: "C", 20: "D", 21: "A",
  22: "TRUE", 23: "NOT GIVEN", 24: "TRUE", 25: "FALSE", 26: "FALSE", 27: "FALSE",
  28: "A", 29: "B", 30: "C", 31: "B", 32: "D",
  33: "E", 34: "F", 35: "H", 36: "C",
  37: "TRUE", 38: "FALSE", 39: "TRUE", 40: "NOT GIVEN"
};

export const mayExplanations = {
  1: { passageId: 1, highlights: ["we know surprisingly little about it", "subject of any real scientific research"], explanation: "Paragraph B explicitly focuses on the lack of scientific research regarding bamboo conservation.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  2: { passageId: 1, highlights: ["tendency to overlook the plants they are associated with, which are often bamboo species."], explanation: "Paragraph F compares how conservationists and the public view bamboo versus hardwoods.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  3: { passageId: 1, highlights: ["bamboo’s most immediate significance lies in its economic value.", "traded commodity"], explanation: "Paragraph D lists the profitable, commercial products made from bamboo.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  4: { passageId: 1, highlights: ["Modern processing techniques mean that it can be used in a variety of ways"], explanation: "Paragraph D contains the exact direct paraphrase, explicitly stating it can be used in a variety of ways.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  5: { passageId: 1, highlights: ["cleared to make way for farms and commercial plantations."], explanation: "Paragraph A directly links human actions to the clearing and destruction of bamboo forests.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  6: { passageId: 1, highlights: ["getting a handle on how to go about it systematically"], explanation: "Paragraph B discusses the methodology of how scientists are approaching the systematic study of bamboo.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  7: { passageId: 1, highlights: ["Patchiness helps to preserve diversity because certain plant species do better"], explanation: "Paragraph C explains how the life and death cycle of bamboo allows other diverse plant species to thrive.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  8: { passageId: 1, highlights: ["Without it, says Ian Redmond, chairman of the Ape Alliance, their chances of survival would be reduced significantly."], explanation: "Ian Redmond (A) makes the direct connection between the loss of bamboo and the reduced survival chances of wildlife.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  9: { passageId: 1, highlights: ["only now are they getting a handle on how to go about it systematically"], explanation: "Valerie Kapos (B) explicitly states that our scientific knowledge of bamboo is very limited.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  10: { passageId: 1, highlights: ["don’t perceive it as being endangered in any way"], explanation: "Kapos (B) points out that local populations often view bamboo as an invasive weed.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  11: { passageId: 1, highlights: ["contributes substantially to poverty alleviation and wealth creation."], explanation: "Chris Stapleton (D) highlights how easily bamboo can be harvested, creating significant economic wealth.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  12: { passageId: 1, highlights: ["crucial in preventing soil erosion."], explanation: "The text directly names 'soil erosion' as the problem prevented by the bamboo's rhizome system.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  13: { passageId: 1, highlights: ["One of the fastest growing bamboo products is paper"], explanation: "'Fastest growing' translates to experiencing market expansion. The product named is paper.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  
  14: { passageId: 2, highlights: ["using the polarization of sunlight to orient themselves... Researchers call this strategy “path integration.”"], explanation: "The passage uses desert ants using sunlight to explain Path Integration (B).", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  15: { passageId: 2, highlights: ["route following, uses landmarks such as buildings and street names, plus directions"], explanation: "Route following (C) is defined as combining landmarks with specific directions.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  16: { passageId: 2, highlights: ["tall, broad MetLife Building? Head for that... Neurologists call this navigational approach “guidance”"], explanation: "Guidance (A) involves using a prominent landmark visible from a distance.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  17: { passageId: 2, highlights: ["if you forget the details and take a wrong turn, the only way to recover is to backtrack"], explanation: "A key weakness of route following (C) is that you must backtrack if you make a mistake.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  18: { passageId: 2, highlights: ["most recent place you recall, and you aim for it. Once there you head for the next notable place... Researchers call this strategy “path integration.”"], explanation: "Path integration (B) involves piecing together a journey by aiming for the most recently recalled spot.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  19: { passageId: 2, highlights: ["stubbornly proceeds in the originally determined direction"], explanation: "The ant ignores the displacement and continues moving according to its original internal vector (C).", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  20: { passageId: 2, highlights: ["Neurobiologists and cognitive psychologists do call the portion of our memory that controls navigation a “cognitive map.”"], explanation: "The text defines the cognitive map as a portion of our brain's memory (D).", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  21: { passageId: 2, highlights: ["To get back to Grand Central, you first envision the large scale-that is, you visualize the general direction of the station."], explanation: "The cognitive map works hierarchically, beginning by visualizing a broad route (A).", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  22: { passageId: 2, highlights: ["The human positioning system is flexible and capable of learning."], explanation: "The passage explicitly confirms this statement as true.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  23: { passageId: 2, highlights: ["If you ask passersby for help, most likely you will receive information in many different forms."], explanation: "The passage says you will receive different forms of information, but it never mentions whether reactions are 'good'.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  24: { passageId: 2, highlights: ["The route-following navigation strategy truly challenges the brain. We have to keep all the landmarks and intermediate directions in our head."], explanation: "Route following requires keeping a highly detailed mental list of landmarks and directions, making it TRUE.", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  25: { passageId: 2, highlights: ["With path integration, our cognitive memory is less burdened;"], explanation: "The statement claims path integration requires more thought, but the text explicitly states it is less burdensome (FALSE).", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  26: { passageId: 2, highlights: ["the notion of a literal map in our heads may be misleading"], explanation: "The passage argues that the 'cognitive map' is just a metaphor and is not an exact, literal map (FALSE).", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  27: { passageId: 2, highlights: ["the notion of a literal map in our heads may be misleading;"], explanation: "The author asserts that thinking we have a literal, accurate map in our heads is misleading (FALSE).", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  
  28: { passageId: 3, highlights: ["reluctant to admit that they have wasted their money."], explanation: "Consumers feel guilty about throwing away an item, so they keep it on a shelf (A).", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  29: { passageId: 3, highlights: ["show what group of people they feel they belong to"], explanation: "Belonging to a specific group is a reflection of a person's social status (B).", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  30: { passageId: 3, highlights: ["gave objects a history-a narrative-and an emotional connection"], explanation: "Narrative means the rich, personal history and emotional storyline connecting the object to its owner (C).", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  31: { passageId: 3, highlights: ["consumerist culture instead idolizes novelty... box-fresh products"], explanation: "Consumers chase the fleeting excitement of something being brand new (B).", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  32: { passageId: 3, highlights: ["this protects it from obsolescence."], explanation: "The emotional bond stops us from throwing items away, proving emotional design makes things last longer (D).", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  33: { passageId: 3, highlights: ["surprisingly slow to take off"], explanation: "The text directly states that the progress of sustainable design has been slow (E).", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  34: { passageId: 3, highlights: ["roots of impending environmental collapse can be summarized in two words: weight and speed."], explanation: "Thackara distills the cause of the crisis to weight and speed (F).", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  35: { passageId: 3, highlights: ["hastened the developed world’s metabolism,"], explanation: "Technology has accelerated the rate at which society consumes and disposes of resources (H).", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  36: { passageId: 3, highlights: ["sourced and distributed locally."], explanation: "Manzini's vision depends on sourcing and distributing goods locally (C).", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  37: { passageId: 3, highlights: ["thrown away having been used, on average, for just ten minutes."], explanation: "The power drill example validates that consumers buy items, barely use them, and discard them (TRUE).", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  38: { passageId: 3, highlights: ["with the extra cost added to the retail price as prepayment."], explanation: "The statement says the cost will be paid after disposing, but the text clarifies it is paid upfront (FALSE).", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  39: { passageId: 3, highlights: ["many big businesses are eagerly adopting sustainable design"], explanation: "Corporations are actively adopting these practices (TRUE).", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." },
  40: { passageId: 3, highlights: [], explanation: "There is absolutely no mention of whether companies will spend more or less money specifically on repairing items in the future (NOT GIVEN).", detailedExplanation: "Other options are incorrect because the provided explanation strictly aligns with the passage evidence. Distractors contradict the text or introduce information not found in the passage." }
};
