...
export const MayWritingTest = ({ submissionId }: { submissionId?: string }) => {
                            ...
                            {currentPart === 1 ? (
                                <div style={{ fontFamily: 'Arial, sans-serif', lineHeight: 1.6, color: '#333' }}>
                                    ...
                                    <p style={{ fontWeight: 'bold', background: '#f9f9f9', padding: '15px', borderLeft: '4px solid #3498db', margin: '20px 0' }}>
                                        The plans below show a college café before it was redesigned and how it looks now.<br/><br/>
                                    ...
                                    <div style={{ width: '100%', backgroundColor: '#fff', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', margin: '20px 0', textAlign: 'center', boxSizing: 'border-box' }}>
                                        <div style={{ width: '100%', display: 'flex', justifyContent: 'center' }}>
                                            <img src="https://lh3.googleusercontent.com/d/1u2dXcuxNb6L_iblbCgbv0pfuIA335y0V=w1000" style={{ width: '100%', height: 'auto', maxHeight: '600px', objectFit: 'contain' }} alt="Task 1 Map" referrerPolicy="no-referrer" />
                                        </div>
                                    </div>
                                ...
                                <div style={{ fontFamily: 'Arial, sans-serif', lineHeight: 1.6, color: '#333' }}>
                                    ...
                                    <p style={{ fontWeight: 'bold', background: '#f9f9f9', padding: '15px', borderLeft: '4px solid #3498db', margin: '20px 0' }}>
                                        Some people say that in the digital age, theatres and cinemas are no longer important as people can watch all the entertainment they want online. Others argue that theatres and cinemas are still important both economically and culturally.<br/><br/>
