...
export const MarchWritingTest = ({ submissionId }: { submissionId?: string }) => {
    ...
    const prompt1Raw = "The graph below shows a typical American and a Japanese office. Summarise the information by selecting and reporting the main features and comparison where relevant. (Assume the diagram shows that the American office has individual cubicles for staff and separate private rooms for managers, while the Japanese office has an open-plan layout with desks grouped together and the manager sitting at the head of the group without a separate room). Write at least 150 words.";
        ...
        if (user) {
            try {
                await addDoc(collection(db, 'submissions'), {
                    ...
                    assignmentId: '11',
                    assignmentTitle: 'IELTS Writing Test 3',
            ...
            {!examStarted && !isSubmitted && (
                <div className="fixed inset-0 bg-gradient-to-br from-[#e0e7ff] via-[#d2d6de] to-[#fbcfe8] z-50 flex items-center justify-center overflow-hidden">
                    ...
                    <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] p-8 w-[500px] max-w-[90%] m-4 z-10 border border-white/40 animate-in fade-in slide-in-from-bottom-4 duration-500">
                        ...
                        <h2 className="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-700 to-purple-700 mb-2 text-center">IELTS Writing Test 3</h2>
                            ...
                            {currentPart === 1 ? (
                                <div>
                                    <p className="text-sm text-gray-900 mb-6 leading-relaxed">
                                        <span className="font-bold">Task 1:</span> The graph below shows a typical American and a Japanese office. Summarise the information by selecting and reporting the main features and comparison where relevant. Write at least 150 words.
                                    </p>
