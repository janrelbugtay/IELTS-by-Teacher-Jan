...
export const JanuaryWritingTest = ({ submissionId }: { submissionId?: string }) => {
    ...
    const prompt2Raw = "Some people think that printed books are no longer needed in the digital era, because all writing can be stored electronically. Others think printed books will still play an important role. Discuss both these views and give your own opinion.";
        ...
        if (user) {
            try {
                await addDoc(collection(db, 'submissions'), {
                    ...
                    assignmentId: '3',
                    assignmentTitle: 'IELTS Writing Test 1',
            ...
            {!examStarted && !isSubmitted && (
                <div className="fixed inset-0 bg-gradient-to-br from-[#e0e7ff] via-[#d2d6de] to-[#fbcfe8] z-50 flex items-center justify-center overflow-hidden">
                    ...
                    <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] p-8 w-[500px] max-w-[90%] m-4 z-10 border border-white/40 animate-in fade-in slide-in-from-bottom-4 duration-500">
                        ...
                        <h2 className="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-700 to-purple-700 mb-2 text-center">IELTS Writing Test 1</h2>
                            ...
                            {currentPart === 1 ? (
                                <div>
                                    <p className="text-sm text-gray-900 mb-6 leading-relaxed">
                                        <span className="font-bold">Task 1:</span> The table below presents the food consumption per a person weekly in European country in 1992, 2002 and 2012. Summarize the information by selecting and reporting the main features, and make comparisons where relevant. Write at least 150 words.
                                    </p>
                                    <div className="mt-8 flex flex-col items-center">
                                        <table className="text-sm w-full max-w-lg border-collapse shadow-sm ielts-table">
                                            <thead>
                                                <tr>
                                                    <th className="w-2/5 text-left font-bold pl-4 py-3 bg-[#082054] text-white border-2 border-white">Food</th>
                                                    <th className="w-1/5 font-bold py-3 bg-[#e4eff8] text-gray-800 border-2 border-white">1992</th>
                                                    <th className="w-1/5 font-bold py-3 bg-[#e4eff8] text-gray-800 border-2 border-white">2002</th>
                                                    <th className="w-1/5 font-bold py-3 bg-[#e4eff8] text-gray-800 border-2 border-white">2012</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                                    <td className="font-bold text-left pl-4 py-2 bg-[#fdf5da] text-gray-900 border-2 border-white">Vegetables (grams)</td>
                                                    <td className="text-center py-2 bg-[#c5e0b3] text-gray-900 border-2 border-white">2140</td>
                                                    <td className="text-center py-2 bg-[#c5e0b3] text-gray-900 border-2 border-white">2190</td>
                                                    <td className="text-center py-2 bg-[#c5e0b3] text-gray-900 border-2 border-white">2220</td>
                                                </tr>
                                                <tr>
                                                    <td className="font-bold text-left pl-4 py-2 bg-[#fdf5da] text-gray-900 border-2 border-white">Meat</td>
                                                    <td className="text-center py-2 bg-[#c5e0b3] text-gray-900 border-2 border-white">1148</td>
                                                    <td className="text-center py-2 bg-[#c5e0b3] text-gray-900 border-2 border-white">1211</td>
                                                    <td className="text-center py-2 bg-[#c5e0b3] text-gray-900 border-2 border-white">1132</td>
                                                </tr>
                                                <tr>
                                                    <td className="font-bold text-left pl-4 py-2 bg-[#fdf5da] text-gray-900 border-2 border-white">Wheat</td>
                                                    <td className="text-center py-2 bg-[#c5e0b3] text-gray-900 border-2 border-white">837</td>
                                                    <td className="text-center py-2 bg-[#c5e0b3] text-gray-900 border-2 border-white">920</td>
                                                    <td className="text-center py-2 bg-[#c5e0b3] text-gray-900 border-2 border-white">977</td>
                                                </tr>
                                                <tr>
                                                    <td className="font-bold text-left pl-4 py-2 bg-[#fdf5da] text-gray-900 border-2 border-white">Bean</td>
                                                    <td className="text-center py-2 bg-[#c5e0b3] text-gray-900 border-2 border-white">532</td>
                                                    <td className="text-center py-2 bg-[#c5e0b3] text-gray-900 border-2 border-white">546</td>
                                                    <td className="text-center py-2 bg-[#c5e0b3] text-gray-900 border-2 border-white">550</td>
                                                </tr>
                                                <tr>
                                                    <td className="font-bold text-left pl-4 py-2 bg-[#fdf5da] text-gray-900 border-2 border-white">Cheese</td>
                                                    <td className="text-center py-2 bg-[#c5e0b3] text-gray-900 border-2 border-white">113</td>
                                                    <td className="text-center py-2 bg-[#c5e0b3] text-gray-900 border-2 border-white">125</td>
                                                    <td className="text-center py-2 bg-[#c5e0b3] text-gray-900 border-2 border-white">125</td>
                                                </tr>
                                            </tbody>
                                        </table>
