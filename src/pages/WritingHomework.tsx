...
import { Award, CheckCircle2, Settings } from 'lucide-react';
...
const LoginScreen = ({ onStart, initialName }: { onStart: (name: string, number: string) => void, initialName: string }) => {
...
const Header = ({ studentName, candidateNumber, timeLeft, saveStatus, onOpenSettings, onOpenSubmit, isSubmitted }: any) => {
