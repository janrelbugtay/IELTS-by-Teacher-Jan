...
export const SeptemberWritingTest = ({ submissionId }: { submissionId?: string }) => {
    ...
    const prompt1Raw = "The diagram gives information about the process of making carbonated drinks. Summarize the information by selecting and reporting the main features, and make comparisons where relevant.";
        ...
        if (user) {
            try {
                await addDoc(collection(db, 'submissions'), {
                    ...
                    assignmentId: '35',
                    assignmentTitle: 'IELTS Writing Test 9',
            ...
            <div className="w-full max-w-4xl flex flex-col items-center mb-12">
                <div className="answer-sheet relative bg-white p-8 md:p-12 border border-gray-300 w-full shrink-0" style={{ width: '210mm', minHeight: '297mm', boxShadow: '0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05)', pageBreakAfter: 'always' }}>
                    ...
                    <div className="mb-4 p-6 bg-gray-50 border-l-4 border-indigo-500 font-sans text-sm text-gray-800 text-left whitespace-pre-wrap">
                        ...
                        {taskNum === 1 && <div className="mt-4 flex justify-center"><img src="https://drive.google.com/thumbnail?id=1ZBw6BPamaIf801hTx52KE1J5yOzsh4Bm&sz=w1000" style={{ maxWidth: '100%', maxHeight: '300px', objectFit: 'contain' }} alt="Task 1 Graph" referrerPolicy="no-referrer" /></div>}
                    </div>
            ...
            {!examStarted && !isSubmitted && (
                <div className="fixed inset-0 bg-gradient-to-br from-[#e0e7ff] via-[#d2d6de] to-[#fbcfe8] z-50 flex items-center justify-center overflow-hidden">
                    ...
                    <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] p-8 w-[500px] max-w-[90%] m-4 z-10 border border-white/40 animate-in fade-in slide-in-from-bottom-4 duration-500">
                        ...
                        <h2 className="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-700 to-purple-700 mb-2 text-center">IELTS Writing Test 9</h2>
                            ...
                            {currentPart === 1 ? (
                                <div style={{ fontFamily: 'Arial, sans-serif', lineHeight: 1.6, color: '#333' }}>                                    <h2 style={{ color: '#d35400', marginTop: '30px', fontSize: '1.4em', fontWeight: 'bold' }}>WRITING TASK 1</h2>
                                    ...
                                    <p style={{ fontWeight: 'bold', background: '#f9f9f9', padding: '15px', borderLeft: '4px solid #3498db', margin: '20px 0' }}>
                                        The diagram gives information about the process of making carbonated drinks. Summarize the information by selecting and reporting the main features, and make comparisons where relevant.
                                    </p>
                                    ...
                                    <div style={{ width: '100%', backgroundColor: '#fff', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', margin: '20px 0', textAlign: 'center', boxSizing: 'border-box' }}>
                                        <div style={{ width: '100%', display: 'flex', justifyContent: 'center' }}>
                                            <img src="https://drive.google.com/thumbnail?id=1ZBw6BPamaIf801hTx52KE1J5yOzsh4Bm&sz=w1000" style={{ width: '100%', height: 'auto', maxHeight: '600px', objectFit: 'contain' }} alt="Task 1 Graph" referrerPolicy="no-referrer" />
                                        </div>
                                    </div>
                                ...
                                <div style={{ fontFamily: 'Arial, sans-serif', lineHeight: 1.6, color: '#333' }}>
                                    ...
                                    <p style={{ fontWeight: 'bold', background: '#f9f9f9', padding: '15px', borderLeft: '4px solid #3498db', margin: '20px 0' }}>
                                        It is argued that the parents of children who break the rules should be punished in some ways as parents are responsible for the children’s actions.<br /><br />
