...
const SPEAKING_FEEDBACK = {
  g: {
    ...
    3: ["Uses mostly simple grammatical structures correctly.", "Attempts some complex structures with mixed success.", "Vocabulary is adequate for familiar topics.", "Frequent reketition of common words.", "Errors occasionally cause awkwardness but meaning remains clear."],
    ...
    5: ["Uses a wide range of A2 grammar accurately.", "Makes only occasional minor errors that do not affect communication.", "Uses varied vocabulary naturally.", "Selects appropriate words for different topics.", "Successfully paraphrases when necessary.", "Expresses ideas precisely and confidently."]
  },
  d: {
  ...
  ga: {
    ...
    1: ["Struggles to complete tasks.", "Communication frequently breaks down.", "Significant examiner support required.", "Performance is below A2 standard."],
    ...
    3: ["Successfully completes most tasks.", "Communication is generally effective.", "Some weaknesses are noticeable.", "Meets the expected A2 standard."],
    ...
    5: ["Completes all speaking tasks confidently.", "Communicates ideas effectively.", "Maintains communication naturally.", "Demonstrates clear A2 ability throughout.", "Requires virtually no examiner assistance."]
  }
};
...
const SPEAKING_FEEDBACK_VI = {
  g: {
    ...
    5: ["Sử dụng chính xác nhiều cấu trúc ngữ pháp ở trình độ A2.", "Chỉ mắc một vài lỗi nhỏ, không ảnh hưởng đến giao tiếp.", "Sử dụng vốn từ đa dạng và tự nhiên.", "Lựa chọn từ phù hợp với nhiều chủ đề khác nhau.", "Có thể diễn đạt lại ý khi cần thiết.", "Diễn đạt ý tưởng chính xác và tự tin."]
  },
  d: {
  ...
  ga: {
    ...
    1: ["Gặp nhiều khó khăn trong việc hoàn thành các nhiệm vụ.", "Giao tiếp thường xuyên bị gián đoạn.", "Cần sự hỗ trợ đáng kể từ giám khảo.", "Thể hiện dưới chuẩn A2."],
    ...
    3: ["Hoàn thành thành công phần lớn các nhiệm vụ.", "Giao tiếp nhìn chung hiệu quả.", "Có một số điểm yếu dễ nhận thấy.", "Đạt chuẩn trình độ A2 theo yêu cầu."],
    ...
    5: ["Hoàn thành tất cả các nhiệm vụ nói một cách tự tin.", "Truyền đạt ý tưởng hiệu quả.", "Duy trì giao tiếp tự nhiên.", "Thể hiện rõ năng lực A2 trong suốt bài thi.", "Hầu như không cần sự hỗ trợ từ giám khảo."]
  }
};
...
export function KETCalculator({ initialTab = 'reading', hideTabs = false, hideHeader = false, onScaleScoreChange = null }: any = {}) {
  const initialScores = {
  ...
  const renderReadingSection = () => (
    <div className="animate-fade-in" key="reading">
      <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
        <Select label="Part 1 (0-6)" value={scores.reading.p1} max={6} onChange={(v) => handleScoreChange('reading', 'p1', v)} theme={activeTheme} />
  ...
  const renderListeningSection = () => (
    <div className="animate-fade-in" key="listening">
      <div className="grid grid-cols-2 md:grid-cols-5 gap-6">
        <Select label="Part 1 (0-5)" value={scores.listening.p1} max={5} onChange={(v) => handleScoreChange('listening', 'p1', v)} theme={activeTheme} />
      ...
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        <div className="text-center space-y-3 mb-10 pt-4 print:hidden animate-fade-in">
          ...
          <p className="text-lg font-medium text-gray-500 max-w-lg mx-auto">
            Accurately calculate and evaluate your Cambridge English A2 Key exam scores.
          </p>
        </div>
