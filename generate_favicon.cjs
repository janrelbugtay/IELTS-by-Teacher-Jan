...
const svgContent = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
  <defs>
    ...
    <path id="topTextPath" d="M 62,210 A 195,195 0 0,1 438,210" fill="none" />
    <path id="bottomTextPath" d="M 438,290 A 195,195 0 0,1 62,290" fill="none" />
  ...
  <text fill="#FFFFFF" filter="url(#textShadow)" fontSize="28" fontWeight="800" fontFamily="system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" letterSpacing="5">
    <textPath href="#topTextPath" startOffset="50%" textAnchor="middle">TRUNG TÂM NGOẠI NGỮ</textPath>
  </text>
  <text fill="#FFFFFF" filter="url(#textShadow)" fontSize="30" fontWeight="900" fontFamily="system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" letterSpacing="4">
    <textPath href="#bottomTextPath" startOffset="50%" textAnchor="middle">KỶ NGUYÊN ERA</textPath>
  </text>
  <g filter="url(#logoShadow)">
    <path d="M 165,215 Q 250,270 335,215 L 335,250 C 335,275 290,295 250,295 C 210,295 165,275 165,250 Z" fill="url(#blueGradient)" />
    ...
    <polygon points="250,135 385,175 250,215 115,175" fill="url(#blueGradient)" stroke="#1E3A8A" strokeWidth="2" />
    <polygon points="250,140 375,175 250,210 125,175" fill="#3B82F6" opacity="0.8" />
  ...
  <text x="250" y="345" textAnchor="middle" fill="#1E3A8A" fontSize="36" fontWeight="900" fontFamily="Georgia, Cambria, 'Times New Roman', Times, serif" letterSpacing="3">ERA ENGLISH</text>
  <text x="250" y="375" textAnchor="middle" fill="#EF4444" fontSize="16" fontWeight="800" fontFamily="system-ui, -apple-system, sans-serif" letterSpacing="6">EST. 2026</text>
</svg>`;

fs.writeFileSync('public/eralogo.svg', svgContent);
console.log('generated public/eralogo.svg');
