...
const content = fs.readFileSync('src/data/test17ReadingData.ts', 'utf8');
...
const newPassage1 = `{
    ...
    questionBlocks: [
      ...
      },
      {
        ...
        instruction: "Complete the following summary of the paragraphs of Reading Passage.\\nUsing NO MORE THAN TWO WORDS from the Reading Passage for each answer.\\nWrite your answers in boxes 9-13 on your answer sheet.\\nBesides normal transport task, changes are also implemented to the trailers in these workshops at the request of the buyers when it was used on a medical emergency or a moveable 9 ______. ‘Ambulance’ is made from metal, with rubber wheels and drive-by another bicycle. When put with 10______ in the two-wheeled ‘ambulance’, the patient can stay comfortable and which another 11______ can sit on caring for the patient in transport journey. In order to dismantle or attach other equipment, and assembling 12______ is designed. Later, as users suggest, 13_______ has also been added to give protection to the patient.",
        type: "fill_in_the_blanks",
        questions: [
          { id: 9, text: "Besides normal transport task, changes are also implemented to the trailers in these workshops at the request of the buyers when it was used on a medical emergency or a moveable {9}. ‘Ambulance’ is made from metal, with rubber wheels and drive-by another bicycle." },
          { id: 10, text: "When put with {10} in the two-wheeled ‘ambulance’, the patient can stay comfortable..." },
          { id: 11, text: "...and which another {11} can sit on caring for the patient in transport journey." },
          { id: 12, text: "In order to dismantle or attach other equipment, and assembling {12} is designed." },
          { id: 13, text: "Later, as users suggest, {13} has also been added to give protection to the patient." }
        ]
      }
    ]
  }`;
...
const replacement = content.replace(
  /\{\s*id:\s*1,\s*title:\s*"READING PASSAGE 1",\s*subtitle:\s*"Passage 1",\s*content:\s*\["Content here"\],\s*questionBlocks:\s*\[\]\s*\}/,
  newPassage1
);

fs.writeFileSync('src/data/test17ReadingData.ts', replacement);
console.log('patched test17');
